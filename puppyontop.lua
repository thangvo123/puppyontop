...
getgenv().gagConfig = {
    ...
    DELETE_PLANTS_AFTER_MAX = { "Mango", "Pyracantha", "Wispwing", "Carrot", "Strawberry", "Blueberry", "Tomato", "Apple", "Burning Bud", "Romanesco", "Sugar Apple", "Giant Pinecone", "Elder Strawberry", "Beanstalk", "Ember Lily", "Pepper", "Spirit Flower", "Cacao", "Grape", "Mangosteen", "Aetherfruit", "Mushroom" },
    ...
    PLANT_EGGS = { "Jungle Egg", "Rare Egg", "Anti Bee Egg", "Bug Egg", "Fall Egg", "Paradise Egg", "Sprout Egg", "Gourmet Egg", "Corrupted Zen Egg", "Enchanted Egg", "Zen Egg", "Dinosaur Egg", "Primal Egg", "Mythical Egg", "Rare Summer Egg", "Common Summer Egg" },
